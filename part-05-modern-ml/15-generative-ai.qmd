...
A foundation model is trained broadly enough that it can support many downstream tasks through mechanisms such as:
...
Top-$p$ or nucleus sampling selects the smallest candidate set whose cumulative probability reaches a threshold $p$.
...
Modern image-generation families include latent-variable, adversarial, autoregressive, and diffusion approaches. Their architectures differ, but the evidence question remains familiar:
