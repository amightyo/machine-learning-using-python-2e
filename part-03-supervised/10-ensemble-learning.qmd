...
AdaBoost increases attention to observations that previous learners classified incorrectly.
...
Gradient boosting provides a broader view.
...
| XGBoost | regularized boosting, mature ecosystem, broad deployment history | tabular prediction and established production/research workflows |
| LightGBM | histogram methods and efficient leaf-wise growth | large tabular datasets and computational efficiency |
| CatBoost | ordered boosting and strong categorical-feature handling | datasets with important categorical predictors |
...
Stacking uses predictions from base models as inputs to a meta-model.
...
An ensemble can have excellent discrimination and poor calibration.
