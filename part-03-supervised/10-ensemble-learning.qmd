...
A practitioner should be able to choose among bagging, boosting, voting, and stacking; control ensemble complexity; prevent stacking leakage; and justify added computational cost with validated gains.

## Researcher Track

A researcher should additionally investigate uncertainty, calibration, stability, external validity, shared biases among component models, and whether ensemble gains support prediction only or a broader scientific claim.
