...
![Conceptual map of AI and modern machine learning.](figures/figure-01-01-ai-ml-map.png){#fig-ai-ml-map fig-cap="A conceptual map of AI, machine learning, and modern learning paradigms."}
...
#| fig-alt: "Line chart of decision-tree accuracy by maximum depth. Training accuracy rises steadily toward perfect fit, while test accuracy peaks at moderate depth and then levels off or declines, illustrating overfitting as complexity increases."
#| warning: false
#| message: false
