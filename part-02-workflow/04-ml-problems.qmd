...
If not, it may create leakage. Leakage can produce systematically overoptimistic estimates of model performance and has become an important reproducibility concern in machine-learning-based science [@kapoorNarayanan2023].
...
Prediction concerns $P(Y\mid X)$. Intervention requires different causal reasoning [@hernanRobins2020].
...
## Computer Vision Is a Workload, Not a Problem Specification
...
- What is the target or output?
- When is the prediction made?
- Which visual information is legitimately available then?
- What is the baseline?
- What errors matter?
- To what cameras, sites, populations, devices, or acquisition conditions should performance generalize?

::: {.callout-important icon=false}
## Research Reality Check

High image-classification accuracy does not establish that a vision system will generalize to new devices, lighting conditions, institutions, populations, or image-acquisition protocols.

In computer vision, **domain shift can be visual**.
:::
...
#| fig-alt: "Line chart showing that the accuracy of always predicting the negative class increases as positive-class prevalence decreases. The plot demonstrates how a naive classifier can appear highly accurate when the positive outcome is rare."
